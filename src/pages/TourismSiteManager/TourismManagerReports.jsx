...
useEffect(() => {
  ...
  fetch(`${API_URL}/tourist-spot-reports`)
    .then((res) => res.json())
    .then((data) => {
      const filtered = data.filter((item) => item.managerId === managerId);
  ...
  const selectedSpot = touristSpots.find((s) => s._id === selectedSpotId);
    ...
    <div className="property-owner-layout">
      ...
      >
        ...
        <div className="po-report-upload-box">
          ...
          <div
            className="tm-spot-select-wrapper"
          ...
          <div className="upload-actions">
            <>
              ...
              <button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  document.getElementById("tmReportUpload").click();
                }}
              >
                + Upload Files
              </button>
            ...
            <button
              ...
              onClick={async (e) => {
                ...
                const managerId = localStorage.getItem("tourismManagerId") || "";
                const managerName = localStorage.getItem("tourismManagerName") || "";
                ...
                try {
                  const res = await fetch(`${API_URL}/tourist-spot-reports`, {
                    method: "POST",
                    body: formData,
                  });
          ...
          <div className="recent-header">
            ...
            {recentUploads.length > 0 && (
              <span className="file-total-badge">
                ...
                {recentUploads.length === 1 ? "File" : "Files"} Total
              </span>
            )}
          </div>
                ...
                {activeMenuIndex === index && (
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={async () => {
                        await fetch(
                          `${API_URL}/tourist-spot-reports/${item._id}`,
                          { method: "DELETE" }
                        );
